...
<head>
    ...
    <title>Creation Abonne </title>
</head>
<body >
    <h2>Creer d'un abonne</h2>
...
$aboTel2 = isset($_POST['aboTel2']) ? $_POST['aboTel2'] : '';
    ...
    if(isset($_POST['submit'])) {
        ...
        if((empty($aboNum) || empty($aboNom) || empty($aboPrenom) ||empty($aboAdresse) ||empty($aboCPostal) || empty($aboVille) || empty($aboTel1) || empty($aboTel2) )) {
            ...
            $sql = "INSERT INTO ABONNE (aboNum,aboNom,aboPrenom,aboAdresse,aboCPostal,aboVille,aboTel1,aboTel2) VALUES ('$aboNum','$aboNom' ,'$aboPrenom','$aboAdresse', '$aboCPostal','$aboVille','$aboTel1','$aboTel2')";

            if(!mysqli_query($con,$sql)) {
                echo '<b>Un abonne n a pas etait créer<b>';
            }else
                {
                    echo '<b>Un abonne est creer<b>';
                }
