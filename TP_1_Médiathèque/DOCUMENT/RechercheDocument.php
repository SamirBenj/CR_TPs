...
<head>
    ...
    <title>Recherche du document </title>
</head>
<body >
    <h2>Recherche du document </h2>
...
$docRef = isset($_POST['docRef']) ? $_POST['docRef'] : '';
    ...
    if(isset($_POST['submit'])) {
        ...
        if((empty($docRef))) {
            ...
            $sql = "SELECT * FROM DOCUMENT WHERE docRef = '$docRef'";

            if(!mysqli_query($con,$sql)) {
                echo '<b>Le document n a pas etait trouver<b>';
            }else
                {
                    echo '<b>le document est trouver<b>';
                }
